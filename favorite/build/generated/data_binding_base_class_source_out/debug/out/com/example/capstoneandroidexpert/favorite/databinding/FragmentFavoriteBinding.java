...
package com.example.capstoneandroidexpert.favorite.databinding;
...
import com.example.capstoneandroidexpert.favorite.R;
...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  private FragmentFavoriteBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rvFavorite,
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoriteBinding((FrameLayout) rootView, rvFavorite, tvEmpty);
    }
